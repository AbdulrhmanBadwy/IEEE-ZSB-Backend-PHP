                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/" aria-current="page"
                                    class="rounded-md text-grey-300 hover:700  px-3 py-2 text-sm font-medium text-white">Home</a>
                                <a href="/about.php"
                                    class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                                <a href="/contact.php"
